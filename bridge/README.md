...
- `set_section_box` — Set section box bounds on a 3D view (explicit or computed from elements)
- `toggle_section_box` — Enable or disable the section box on a 3D view
