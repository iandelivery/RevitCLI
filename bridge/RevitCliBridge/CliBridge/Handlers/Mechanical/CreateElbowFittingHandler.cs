...
{
    /// <summary>
    /// Creates an elbow fitting between two duct connectors. The connectors
    ...
    {
        public override string CommandName => "create_duct_elbow_fitting";
        public override string Description => "Creates an elbow fitting between two duct connectors";
        public override string Category => "Create";
        public override string[] Aliases => new[] { "duct_elbow_fitting" };
        ...
        protected override string Execute(UIApplication app, Document doc, Dictionary<string, object> parameters, QueuedCommand cmd)
        {
            ...
            using var tx = new DryRunTransaction(doc, "CLI Create Duct Elbow Fitting", cmd.DryRun);
            try
            {
